...
CREATE TABLE dependientes (
  dependiente_id INT AUTO_INCREMENT PRIMARY KEY,
...
(1,'Europa'),(2,'Américas'),(3,'Asia-Pacífico'),(4,'Oriente Medio/África');

INSERT INTO paises (pais_id, pais_nombre, region_id) VALUES
...
INSERT INTO ubicaciones (ubicacion_id, direccion, codigo_postal, ciudad, estado_provincia, pais_id) VALUES
...
INSERT INTO trabajos (trabajo_id, trabajo_nombre, salario_min, salario_max) VALUES
...
INSERT INTO departamentos (departamento_id, departamento_nombre, ubicacion_id) VALUES
(1,'Administration',1700),(2,'Marketing',1800),(3,'Purchasing',1700),(4,'Human Resources',2400),
(5,'Shipping',1500),(6,'IT',1400),(7,'Public Relations',2700),(8,'Sales',2500),
(9,'Executive',1700),(10,'Finance',1700),(11,'Accounting',1700);

INSERT INTO empleados (empleado_id,nombres,apellidos,email,numero_telefono,fecha_ingreso,trabajo_id,salario,gerencia_id,departamento_id) VALUES
...
INSERT INTO dependientes (dependiente_id,nombres,apellidos,vinculo,empleado_id) VALUES
